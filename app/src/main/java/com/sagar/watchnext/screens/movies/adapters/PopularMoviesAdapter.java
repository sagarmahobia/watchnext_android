 ...
 */
@MoviesFragmentScope
public class PopularMoviesAdapter extends BaseRecyclerAdapter {

    private MoviesFragmentMvpContract.Presenter presenter;

    @Inject
      PopularMoviesAdapter(Picasso picasso, MoviesFragmentMvpContract.Presenter presenter) {
        super(picasso);
    ...
    public void onBindViewHolder(@NonNull CardViewHolder cardViewHolder, int position) {
        presenter.onBindPopularMovieCard(cardViewHolder, position);
