...
open class BaseViewModel(private val tmdbRepository: TMDBRepository) : ViewModel() {
    ...
    fun loadInTheatersMovies() {
        disposables.add(tmdbRepository.getFirstPage("movie", "now_playing").subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe({ movies: Result ->
    ...
    fun loadUpcomingMovies() {
        disposables.add(tmdbRepository.getFirstPage("movie", "upcoming").subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe({ movies: Result ->
    ...
    fun loadPopularMovies() {
        disposables.add(tmdbRepository.getFirstPage("movie", "popular").subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe({ movies: Result ->
            popularMovies.clear()
    ...
    fun loadTopRatedMovies() {
        disposables.add(tmdbRepository.getFirstPage("movie", "top_rated").subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe({ movies: Result ->
    ...
    fun loadAiringTodayShows() {
        disposables.add(tmdbRepository.getFirstPage("tv", "airing_today").subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe({ shows: Result ->
    ...
    fun loadOnTheAirTodayShows() {
        disposables.add(tmdbRepository.getFirstPage("tv", "on_the_air").subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe({ shows: Result ->
            onTheAirShows.clear()
    ...
    fun loadPopularShows() {
        disposables.add(tmdbRepository.getFirstPage("tv", "popular").subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe({ shows: Result ->
            popularShows.clear()
    ...
    fun loadTopRatedShows() {
        disposables.add(tmdbRepository.getFirstPage("tv", "top_rated").subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe({ shows: Result ->
            topRatedShows.clear()
